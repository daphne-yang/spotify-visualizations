...
headers = {'Authorization': 'Bearer QVcv1b9UiW5yvCxJ27nwWvwXvhlFO24BbztO6FMosdpOIeTHfFfJ_Gr7Wq6C_Qep'}
...
def get_missing(song_title, artist_name):
  ...
  for hit in json["response"]["hits"]:
      genius_artist_result = strip_accents(hit["result"]["primary_artist"]["name"]).lower()
